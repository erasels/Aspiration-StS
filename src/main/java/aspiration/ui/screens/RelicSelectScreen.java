...
//CREDITS TO Hubris from Kiooeht
//I COPIED THIS 1:1
public class RelicSelectScreen implements ScrollBarListener
{
    private static final UIStrings uiStrings = CardCrawlGame.languagePack.getUIString("hubris:RelicViewScreen");
