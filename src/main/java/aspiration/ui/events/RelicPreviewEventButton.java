...
public class RelicPreviewEventButton extends LargeDialogOptionButton {
    ...
    public RelicPreviewEventButton(int slot, String msg, AbstractRelic r, boolean isDisabled, AbstractCard previewCard) {
        ...
        this.pressed = false;
        this.slot = 0;
        switch (com.megacrit.cardcrawl.events.AbstractEvent.type) {
            case TEXT:
    ...
    public RelicPreviewEventButton(int slot, String msg, AbstractRelic r) {
        this(slot, msg, r, false, null);
    }
    ...
    public void renderRelicPreview(SpriteBatch sb) {
        if ((this.r != null) && (this.hb.hovered)) {
            ...
            TipHelper.queuePowerTips(InputHelper.mX - 350.0F * Settings.scale, Settings.HEIGHT / 3.0F, this.r.tips);
        }
    }
