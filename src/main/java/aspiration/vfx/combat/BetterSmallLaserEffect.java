...
public class BetterSmallLaserEffect extends AbstractGameEffect {
    private float sX;
    private float sY;
    private float dX;
    private float dY;
    ...
    public BetterSmallLaserEffect(float sX, float sY, float dX, float dY, float dur, Color col) {
        if (img == null) {
    ...
    public BetterSmallLaserEffect(float sX, float sY, float dX, float dY, float dur) {
        this(sX, sY, dX, dY, dur, Color.CYAN);
    }
