...
public class Headhunter extends AspirationRelic implements CustomSavable<Integer[][]>{
    ...
    private static final int BUFF_CARRYOVER_AMOUNT = 4;
    ...
    public Headhunter() {
        super(ID, "Headhunter.png", RelicTier.RARE, LandingSound.MAGICAL);
    ...
    private void fillBuffListNorm(ArrayList<AbstractPower> pl) {
    	...
    	pl.add(new IntangiblePower(AbstractDungeon.player, 1));	
    	...
    	pl.add(new TheBombPower(AbstractDungeon.player, 10, 100));						//Deal 100 damage to all enemies after 10 turns
